...
// Binary Protocol PortValue Struct (Must be at top for Gateway headers)
struct PortValue {
  char type[2];
  uint16_t value;
};
...
class SX126x {
  public:
    ...
    int16_t  begin(uint32_t frequencyInHz = 915000000, int8_t txPowerInDbm = 22, float tcxoVoltage = 0.0, bool useRegulatorLDO = false);
